    ...
    public class ServiceR
    {
        public static async void CheckSystem()
        {
            ...
            static void Check()
            {
                ...
                string thisDll = $"{DopInstruments.ChangeDirectory(Environment.CommandLine).Replace('\\', '/')}/check/UniShell-main/UniShell 2.1 BETA1/publish/win-x64/Operture.dll";
                ...
                var check = File.ReadAllBytes(Environment.CommandLine)[0] == File.ReadAllBytes(thisDll)[0];
