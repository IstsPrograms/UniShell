...
namespace Cmds
{
    public class CommandsR
    {
        ...
        public static void sys()
        {
            ...
            Console.Write($"##             ##");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine($"     ENV: HydriumLite 1.2");
            Console.ForegroundColor = ConsoleColor.DarkRed;
            Console.Write($"##             ##");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine($"     SHV: UniShell 2.3");
            Console.ForegroundColor = ConsoleColor.DarkRed;
            Console.Write($"##             ##");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("     CMD: CommandsR 1.1");
            Console.ForegroundColor = ConsoleColor.DarkRed;
            Console.WriteLine($" ##           ##");
            Console.WriteLine($"  ##         ## ");
            Console.WriteLine($"   ###########");
        ...
        public static void help()
        {
            ...
            Engine.OutputSysNE("[HELP] contacts");
            Engine.OutputSysNE("[HELP] ls");
            Engine.OutputSysNE("[HELP] clear");
            Engine.OutputSysNE("[HELP] listenport <port> <filename>");
        ...
        {
            Engine.OutputSysNE("[CONTACTS] My discord server: https://discord.gg/7PRqKTAcRX");
        }
        ...
        public static void about()
        {
            ...
            else
            {
                ...
                {
                    case "run":
                        Engine.OutputSysNE("[ABOUT] Using command run you can execute files with extensions .exe, .bat, .sh");
                        break;
                }
            }
        }
