...
namespace OperManager
{
    ...
    public class Operture
    {
        ...
        public Operture(Delegate[]? commands, Action[]? services, Delegate[]? executingEngines, Logger log)
        {
            ...
            this.log = log;
            macros = new Macros();
            plugins = new Plugin[Directory.GetFiles($"C:\\Users\\{Environment.UserName}\\UniPlugins").Length];
            string[] plugs = Directory.GetFiles($"C:\\Users\\{Environment.UserName}\\UniPlugins");
            int countOfLoaded = 0;
